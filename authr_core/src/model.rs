...
/// Account data safe to cross the Rust ⇄ webview bridge for the account list — name only.
/// The base32 `secret` is deliberately absent: secrets never cross the bridge.
